declare module "bottleneck" {
  ...
  class Bottleneck {
    ...
    wrap<R>(
      fn: () => PromiseLike<R>,
    ): (() => Promise<R>) & { withOptions: (options: Bottleneck.JobOptions) => Promise<R> };
    wrap<R, A1>(
      fn: (arg1: A1) => PromiseLike<R>,
    ): ((arg1: A1) => Promise<R>) & {
      withOptions: (options: Bottleneck.JobOptions, arg1: A1) => Promise<R>;
    };
    wrap<R, A1, A2>(
      fn: (arg1: A1, arg2: A2) => PromiseLike<R>,
    ): ((arg1: A1, arg2: A2) => Promise<R>) & {
      withOptions: (options: Bottleneck.JobOptions, arg1: A1, arg2: A2) => Promise<R>;
    };
    wrap<R, A1, A2, A3>(
      fn: (arg1: A1, arg2: A2, arg3: A3) => PromiseLike<R>,
    ): ((arg1: A1, arg2: A2, arg3: A3) => Promise<R>) & {
      withOptions: (options: Bottleneck.JobOptions, arg1: A1, arg2: A2, arg3: A3) => Promise<R>;
    };
    wrap<R, A1, A2, A3, A4>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4) => PromiseLike<R>,
    ...
    wrap<R, A1, A2, A3, A4, A5>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5) => PromiseLike<R>,
    ...
    wrap<R, A1, A2, A3, A4, A5, A6>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6) => PromiseLike<R>,
    ): ((arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6) => Promise<R>) & {
      withOptions: (
        options: Bottleneck.JobOptions,
        arg1: A1,
        arg2: A2,
    ...
    wrap<R, A1, A2, A3, A4, A5, A6, A7>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6, arg7: A7) => PromiseLike<R>,
    ): ((arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6, arg7: A7) => Promise<R>) & {
      withOptions: (
        options: Bottleneck.JobOptions,
        arg1: A1,
        arg2: A2,
    ...
    wrap<R, A1, A2, A3, A4, A5, A6, A7, A8>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    wrap<R, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    wrap<R, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    submit<R>(
      fn: (callback: Bottleneck.Callback<R>) => void,
      callback: Bottleneck.Callback<R>,
    ): void;
    submit<R, A1>(
      fn: (arg1: A1, callback: Bottleneck.Callback<R>) => void,
      arg1: A1,
      callback: Bottleneck.Callback<R>,
    ): void;
    submit<R, A1, A2>(
      fn: (arg1: A1, arg2: A2, callback: Bottleneck.Callback<R>) => void,
      arg1: A1,
      arg2: A2,
      callback: Bottleneck.Callback<R>,
    ): void;
    submit<R, A1, A2, A3>(
      fn: (arg1: A1, arg2: A2, arg3: A3, callback: Bottleneck.Callback<R>) => void,
      arg1: A1,
      arg2: A2,
      arg3: A3,
      callback: Bottleneck.Callback<R>,
    ): void;
    submit<R, A1, A2, A3, A4>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4, callback: Bottleneck.Callback<R>) => void,
      arg1: A1,
      arg2: A2,
      arg3: A3,
      arg4: A4,
    ...
    submit<R, A1, A2, A3, A4, A5, A6, A7, A8>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    submit<R, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    submit<R, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    schedule<R, A1, A2, A3, A4, A5, A6, A7>(
      fn: (arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6, arg7: A7) => PromiseLike<R>,
      arg1: A1,
      arg2: A2,
      arg3: A3,
    ...
    schedule<R, A1, A2, A3, A4, A5, A6, A7, A8>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    schedule<R, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
    ...
    schedule<R, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>(
      fn: (
        arg1: A1,
        arg2: A2,
        arg3: A3,
