  ...
  describe("Cluster-only", function () {
    ...
    it("Should queue up the least busy limiter", async function () {
      ...
      var p1 = new Promise(function (resolve, reject) {
        resolve1 = function (err, n) {
          resolve(n);
        };
      });
      var p2 = new Promise(function (resolve, reject) {
        resolve2 = function (err, n) {
          resolve(n);
        };
      });
      var p3 = new Promise(function (resolve, reject) {
        resolve3 = function (err, n) {
          resolve(n);
        };
      });
      var p4 = new Promise(function (resolve, reject) {
        resolve4 = function (err, n) {
          resolve(n);
        };
      });
      var p5 = new Promise(function (resolve, reject) {
        resolve5 = function (err, n) {
          resolve(n);
        };
      });
      var p6 = new Promise(function (resolve, reject) {
        resolve6 = function (err, n) {
          resolve(n);
        };
      });
      var p7 = new Promise(function (resolve, reject) {
        resolve7 = function (err, n) {
          resolve(n);
        };
      });
